using OfferteMakerApi;
using OfferteMakerApi.Extensions;
using OfferteMakerApi.Presentation.ActionFilters;
using OfferteMakerApi.Utility;
using Contracts;
...
builder.Services.AddControllers(config =>
{
  ...
  .AddApplicationPart(typeof(OfferteMakerApi.Presentation.AssemblyReference).Assembly);
